...
export const CHANNEL_META: Record<Channel, { label: string; color: string; blurb: string }> = {
  ...
  pledge:      { label: "Pledge",       color: "#f43f5e", blurb: "CNC · promoter pledge-release (deleveraging)" },
};
...
export const CHANNEL_ORDER: Channel[] = ["swing", "intraday", "pead", "core", "momentum", "delivery", "insider", "pledge"];
