    ...
    () => [
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span
              className={cn(
                ...
                r.wl_type === "swing" || posChannel(r) === "core" || posChannel(r) === "momentum" || posChannel(r) === "delivery" || posChannel(r) === "insider" || posChannel(r) === "pledge"
                  ? "bg-indigo-500/15 text-indigo-400"
                  : "bg-cyan-500/15 text-cyan-400",
              )}
            >
              {r.wl_type === "swing" || posChannel(r) === "core" || posChannel(r) === "momentum" || posChannel(r) === "delivery" || posChannel(r) === "insider" || posChannel(r) === "pledge" ? "CNC" : "MIS"}
            </span>
      ...
      },
      {
        ...
        render: (r) => {
          ...
          if (posChannel(r) === "pledge") {
            return <span className="text-[10px] text-text-secondary font-sans">HOLD · ~60d</span>;
          }
      ...
      },
      {
        ...
        label: "R:R",
        render: (r) => {
          if (posChannel(r) === "core" || posChannel(r) === "momentum" || posChannel(r) === "delivery" || posChannel(r) === "insider" || posChannel(r) === "pledge") return <span className="text-text-secondary/40">—</span>;
