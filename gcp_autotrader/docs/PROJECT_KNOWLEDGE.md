...
|---|---|---|
| `autotrader` | `autotrader-00249-ndb` | PAPER; **Phase C v1.1** (per-channel limits + PortfolioBook channel_pct aligned to 50/50), ₹1L swing + ₹1L intraday, risk ₹1,500, dedup, holiday-aware (2026-05-28) |
