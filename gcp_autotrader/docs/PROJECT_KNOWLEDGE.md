...
### K. Swing 9.7% config — PAPER forward-validation (ACTIVE 2026-07-03)

Config live in PAPER (rev `00281-nbl`) but NOT yet validated forward or live (real money). Watch over the next live sessions:
...
### 2026-07-03 (latest) — ⑩ SWING 9.7% CONFIG SHIPPED TO PAPER (PR #51, rev `autotrader-00281-nbl`)
