...
>
> **Last verified live state:** **2026-08-25 18:55 IST** — every value below read from live
> `gcloud` in that session, not carried forward:
> `autotrader-00318-ws6` · `autotrader-ws-monitor-00048-b9g` · `autotrader-dashboard-00084-pgl` ·
> **PAPER** · 60 open positions · schedulers **41 ENABLED / 3 PAUSED** (2 intraday + 1 gapfade,
> all intentional) · `autotrader-insider-ingest-1930` = `30 19 * * *` (weekend runs enabled) ·
> `origin/main` = `1d9036e`, **main checkout in sync** (Rule 1 clear) · tests 1119 passed / 5
> skipped · forward test **2 closed, +₹575.19**.
>
