...
>
> **Last verified live state:** **2026-08-28 13:30 IST (Fri)** — every value below re-read from
> live `gcloud` at that moment, not carried forward:
> **`autotrader-00320-nxm`** · `autotrader-ws-monitor-00048-b9g` · `autotrader-dashboard-00084-pgl` ·
> **PAPER** · 60 open positions (core 30 · momentum 20 · delivery 5 · insider 3 · pledge 2) ·
> schedulers **41 ENABLED / 3 PAUSED** (2 intraday + 1 gapfade, all intentional) ·
> `autotrader-insider-ingest-1930` = `30 19 * * *` · tests 1119 passed / 5 skipped ·
