...
UPSTOX_ANALYTICS_TOKEN_SECRET_NAME="${UPSTOX_ANALYTICS_TOKEN_SECRET_NAME:-upstox-analytics-token}"
...
ENV_VARS=(
  ...
  "UPSTOX_ANALYTICS_TOKEN_SECRET_NAME=$UPSTOX_ANALYTICS_TOKEN_SECRET_NAME"
